...
public class Goku extends Personajes {
	...
	public void poderFuerte() {
		if (getBOLA_DE_PODER() > 0) {
			...
			escenario.getSonidoCache().playSonido("audio/BOLA_DE_PODER.wav");
		}
	...
	public void invocarAYUDANTE_UNO() {
		if (getAYUDANTE_UNO() > 0) {
			AYUDANTE_UNO--;
			AYUDANTE_UNO AYUDANTE_UNO = new AYUDANTE_UNO(escenario);
	...
	public void invocarAYUDANTE_DOS() {
		if (getAYUDANTE_DOS() > 0) {
			AYUDANTE_DOS--;
			AYUDANTE_DOS AYUDANTE_DOS = new AYUDANTE_DOS(escenario);
